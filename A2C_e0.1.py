...
def run_reinforce_with_Net(seed, clip=False, entropy=False, entropy_weight=0.1):
...
if __name__ == "__main__":
    ...
    df_eval.to_csv('./results/reinforce_a2c_entropy0.1_score.csv', index=False)
    ...
    os.makedirs('./results', exist_ok=True)
    df.to_csv('./results/reinforce_a2c_entropy0.1_results.csv', index=False)
