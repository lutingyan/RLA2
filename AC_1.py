...
def compute_returns(rewards, dones, values, gamma=0.99, n_steps=1):
...
if __name__ == "__main__":
    ...
    df_eval.to_csv('./results/ac_1_score.csv', index=False)
    ...
    os.makedirs('./results', exist_ok=True)
    df.to_csv('./results/ac_1_results.csv', index=False)
